...
def session_bus_sync(bus_address=None, main_context=None):
    return MessageBus(bus_address=bus_address, bus_type=BusType.SESSION, main_context=main_context).connect_sync()
...
def system_bus_sync(bus_address=None, main_context=None):
    return MessageBus(bus_address=bus_address, bus_type=BusType.SYSTEM, main_context=main_context).connect_sync()
